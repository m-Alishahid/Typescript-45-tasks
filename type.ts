...
//(task3 Name cases)
let firstName:string ="AliShahid";
...
let Quote:string=" With faith,discipline and selfless devotion of duty,there is nothing worthwhile that you cannot achieve. ";
...
//(task11 array)
let names:string []=["Ali","Bilal","Hamza","Rohan"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
//(task12) 
let personnames:string []=["Ali","Bilal","Hamza","Rohan"];
let text:string ="Do you like Programming?"
...
//(task16 More Guests)
//part1
let guestArray3:string[]=["Ali","Rohan","Shahid","Bilal"];
let cannotAttend="Rohan";
let newGuest1:string= "Haider";
...
let Guest:string[]=["Qasim","Ali","Rohan","Hamza","Haider"]
...
//(task18)
let placeTovisit:string[]=["China","Pakistan","Portugal","Canada","Brazil"];
...
//(task19 Dinner Guest)
let invitation:string[]=["Qasim","Ali"];
let count_invitation:number=invitation.length
console.log(`${count_invitation} people will come to the dinner`);


//(task20)
let places:string[]=["Singapore","Pakistan","Thailand","Dubai","China"];
console.log("List of Country:");
console.log(places);


//(task21)
let person:{name:string,fatherName:string,age:number}={name:"M.Ali",fatherName:"M.Shahid",age:17 }
console.log(person)
...
let num1:string ="Ali";
let num2:string="Ali Shahid";
let num3:string="Muhammad Ali Shahid";
if(num1==num3){
...
let dateofBirth1:number=24;
let dateofBirth2:number=26;
if(dateofBirth1==24){
...
let fruitBasket:string[]=["Mangoes","Watermelons","Apples","Graps"];
...
let favoriteFruits:string[]=["Banana","Mango","Watermelon","Peach","Guava"]
...
//(task30 Hello Admin)
let users:string[]=["Eric","Ali","Rohan","Danial","admin"]
...
//(task31 No User)
let user:string[]=["Eric","Ali","Rohan","Danial","admin"]
...
let currentUser:string[]=["Ahmed","Ali","Daniel","Hamza","Bilal"]
let newUser:string[]=["Ali","Daniel","Fatima","Aliza","Qasim"];
let currentUserlower:string[]=currentUser.map(user=> user.toLowerCase());
...
//(task34 Pizzas)
let favPizza:string[]=["Chicken","pepperonl","Veg"];
...
//(task37 Large Shirt)
function make_shirt(size:string='Large',text:string='    I love tyepscript'):void{
...
//(task39 City Names)
function city(city:string,country:string):string{
    return`${city},${country}`
}
...
const Magician:string[]=["harry","devis","robert sheiun"];
...
const magicians2:string []=["Neil Voltar","Actotoile","Aurther"];
...
const magicians3:string[]=["Neil Volter","Actotile","Aurther"];
...
//Finally all task are completed related to typescript programming.